...
export const EntryAllHTML = (entryObj) => {
    ...
    <li class="list-entry__container" id="list-entry__id--${entryObj.id}">
        ...
        <div class="list-entry__flex-btn">
            <button type="button" id="editEntry--${entryObj.id}" class="button btn--edit">Edit</button>
            <button type="button" id="deleteEntry--${entryObj.id}" class="button btn--delete">Delete</button>
        </div>
    </li>
    `
}
